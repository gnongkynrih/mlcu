            ...
            <table class="min-w-full divide-y divide-gray-100">
                <thead class="bg-gray-50/80 backdrop-blur-sm">
                    <tr>
                        <th 
                            scope="col" 
                            class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:text-gray-700 transition-colors" 
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                @if($sortField === 'name')
                                    ...
                                    <x-icon name="o-chevron-down" class="w-4 h-4 {{ $sortDirection === 'asc' ? '' : 'rotate-180' }} transition-transform duration-500" />
                                @endif
                            </div>
                        </th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($menuItems as $item)
                        <tr class="hover:bg-gray-50/80 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <x-toggle wire:click="toggleAvailability({{ $item->id }})"  :checked="$item->is_available == 1" />
                            </td>
